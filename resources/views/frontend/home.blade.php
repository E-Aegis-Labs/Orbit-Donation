...
@section('main_content')
        ...
        <div class="-mx-4 flex flex-wrap items-center">
              ...
              >
                <li>
                  <a
                    ...
                    class="inline-flex items-center justify-center rounded-md  px-7 py-[14px] text-center text-base font-medium text-dark shadow-1 transition duration-300 ease-in-out hover:bg-gray-2 hover:text-body-color"
                  >
                    Download Now
                  </a>
                </li>
                <li>
                  <a
                    ...
                    target="_blank"
                    class="flex items-center gap-4 rounded-md /[0.12] px-6 py-[14px] text-base font-medium text-white transition duration-300 ease-in-out hover: hover:text-dark"
                  >
                    <svg
                      class="fill-current"
                      width="24"
          ...
          <div class="w-full px-4">
            ...
            <section class="relative bg-gradient-to-br from-blue-900 to-indigo-800 text-white overflow-hidden">
              ...
              <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('https://telegra.ph/file/bbd5287058f5c07707ab4.jpg');"></div>
                  ...
                  <div class="flex flex-col md:flex-row items-center justify-between">
                      ...
                      <div class="w-full md:w-1/2 mb-12 md:mb-0">
                          ...
                          <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                              <a href="#" class="bg-gradient-to-r from-purple-500 to-purple-900 text-blue-900 font-semibold px-8 py-3 rounded-full hover:bg-blue-100 transition duration-300 text-center">Get Started</a>
                              <a href="#" class="bg-gradient-to-tr from-emerald-500 to-emerald-900 text-green-900 font-semibold px-8 py-3 rounded-full hover:bg-blue-100 transition duration-300 text-center">Start Today</a>
                          </div>
                      </div>
              ...
              <div class="absolute bottom-0 left-0 right-0">
                  <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M0 120L60 105C120 90 240 60 360 45C480 30 600 30 720 37.5C840 45 960 60 1080 67.5C1200 75 1320 75 1380 75L1440 75V120H1380C1320 120 1200 120 1080 120C960 120 840 120 720 120C600 120 480 120 360 120C240 120 120 120 60 120H0Z" fill="green"/>
                  </svg>
              </div>
          </section>
    <!-- ====== Hero Section End -->
          ...
          <div class="container max-w-screen-xl mx-auto px-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                  <div class="px-6 py-6 w-full border-2 border-gray-200 rounded-3xl">
                      <img src="https://telegra.ph/file/10de92fcc7e777fe4e74b.jpg" alt="Image" class="mb-6 hover:opacity-75 transition ease-in-out duration-500">
                      ...
                      <button class="w-full py-4 bg-violet-950 font-semibold text-white text-lg rounded-xl hover:bg-purple-800 transition ease-in-out duration-500">Donate</button>
                  </div>
                  ...
                  <div class="px-6 py-6 w-full border-2 border-gray-200 rounded-3xl">
                      ...
                      <button class="w-full py-4 bg-violet-950 font-semibold text-white text-lg rounded-xl hover:bg-blue-800 transition ease-in-out duration-500">Donate</button>
                  </div>
    ...
    {{-- <section
      id="pricing"
      class="relative z-20 overflow-hidden  pb-12 pt-20 dark:bg-dark lg:pb-[90px] lg:pt-[120px]">
      <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            <div
              class="relative z-10 mb-10 overflow-hidden rounded-xl  px-8 py-10 shadow-pricing dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-14"
            >
              <span
    ...
    <!-- ====== FAQ Section Start -->
    <section
      class="relative z-20 overflow-hidden  pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]"
    >
      <div class="container mx-auto">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
      ...
      <div class="container mx-auto">
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4 xl:w-1/4">
            <div
              class="group mb-8 rounded-xl  px-5 pb-10 pt-12 shadow-testimonial dark:bg-dark dark:shadow-none"
            >
              ...
              <div id="swiper_Two" class="swiper">
                  ...
                  <div class="swiper-wrapper mb-20">
                      <div class="swiper-slide">
                        <div
                          class="rounded-xl  px-4 py-[30px] shadow-testimonial dark:bg-dark sm:px-[30px]"
                        >
