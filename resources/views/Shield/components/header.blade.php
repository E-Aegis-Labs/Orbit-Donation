    ...
    <div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        ...
        <div class="hidden sm:block">
            ...
            <div class="flex rounded-full bg-[#0d1829] px-2 w-full max-w-[600px]">
                <button class="self-center flex p-1 cursor-pointer "> <svg width="30px" height="30px"
                ...
                <input type="text" class="w-full bg-[#0d1829] flex bg-transparent pl-2 text-[#cccccc] rounded-full"
                    placeholder="" />
