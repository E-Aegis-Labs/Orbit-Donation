...
@section('content')
    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
            <!-- ====== Chart One Start -->
            @include('Shield.components.chart-01')
            <!-- ====== Chart One End -->

            <!-- ====== Chart Two Start -->
            @include('Shield.components.chart-02')
            <!-- ====== Chart Two End -->

            <!-- ====== Chart Three Start -->
            @include('Shield.components.chart-03')
            <!-- ====== Chart Three End -->

            <!-- ====== Map One Start -->
            @include('Shield.components.map-01')
            <!-- ====== Map One End -->

            <!-- ====== Table One Start -->
            <div class="col-span-12 xl:col-span-8">
                @include('Shield.components.table-01')
            </div>
            <!-- ====== Table One End -->
